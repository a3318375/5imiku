            ...
            $.get('/blog/json?pageNumber='+page, function(res){
                ...
                layui.each(res.list, function(index, item){
                    var code = '<div class="article shadow"><div class="article-left">' +
                        '<img src="${pageContext.request.contextPath}/resources/blg/images/cover/201703181909057125.jpg" alt="基于laypage的layui扩展模块（pagesize.js）！" />' +
                        ...
                        '</i>&nbsp;&nbsp;<fmt:formatDate value="${blog.createDate}" type="date" dateStyle="long"/>' +
